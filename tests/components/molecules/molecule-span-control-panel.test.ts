...
const pluginItemsMock = [
  ...
  { id: 2, data: [{ id: 2, ext_id: 'b', label: 'Citation',categories: ["role 1","role 2"] },{id:4,ext_id:'4',label:'Co Ref', categories: ["ref1","ref2"]}] }
      ...
      spanArray : ref([
        ...
        },
        {
          ...
          plugins:{
            "plugin-2": [
              {
                id:4,ext_id:'4',label:'Co Ref', categories: ["ref1","ref2"]
              }
            ]
          }
        },
