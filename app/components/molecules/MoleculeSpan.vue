<template>
  <molecule-span-wrapper class="flex h-full w-full">
    <Splitter class="h-full" state-storage='local' state-key="ground-control-span">
      <SplitterPanel class="bg-secondary" :size="45"> 
        <div :class="` flex flex-col h-full relative `">
          <div>
            <AtomSearch class='hidden'  :spans="spanArray" />
          </div>
          <div class="grow h-0 flex justify-center relative overflow-visible min-w-0">
