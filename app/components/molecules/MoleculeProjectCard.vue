    ...
    <div>
      <div class="min-h-[75%] max-h-full">
        <div class="flex justify-between align-middle pl-2">
          <p class="font-bold text-2xl self-center">
            {{ formatTitle(project.title) }}
          </p>
          <p class="h-[66px] w-[24px] flex flex-col items-center gap-2">
            <Button
              style="height: 18px; width: 18px; color: #282828"
              class="mt-3"
      ...
      <div
        class=" w-full flex justify-between pl-2 py-2 text-sm">
        <p
...
const { project } = defineProps({
  project: { type: Object as PropType<ProjectDetailDto>, default: () => {} },
});
