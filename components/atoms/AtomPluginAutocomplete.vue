<template>
  <div v-if="indexPlugin<3 && !source" class="flex grow min-w-fit ">
      <MultiSelect :disabled="!isAnnotationEditable"  v-model="selectedItems" :options="sortedOptionsByFilter" optionLabel="label" filter filterMatchMode="contains"  :placeholder="pluginName"
