  ...
  <div class="bg-white max-w-full w-full h-fit p-6 overflow-scroll" >
    <div>
      <panel-span-header class="flex justify-between items-center">
        ...
        <span-filter class="flex items-center gap-2">
    ...
    <div v-if="isForResearch" class="py-2">
      <div class="flex justify-start items-center gap-3 h-7">
    ...
    <div v-if="isForResearch" class="flex flex-col">
      <category-header class="flex flex-row justify-between items-center">
        ...
        <div class="flex items-center gap-4">
          <group-filter class="flex items-center gap-2">
            ...
            >
              <delete-group-wrapper class="flex flex-col gap-6">
                ...
                <delete-group-footer class="flex flex-row justify-end gap-2">
                  <Button outlined severity="primary" icon="pi pi-times" label="Annuler" @click="handleCancelRemoveGroup()" />
